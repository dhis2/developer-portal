...
<form action="https://pub.dialogapi.no/s/MjE5NDg6ZTQ3NDU4NjItOTY1OS00MDY1LTlkN2EtMWVlM2Y3YTE5OWRl" accept-charset="utf-8" method="post" className="mnm-embed-form card">
<div className="card__header"><h3>Signup form:</h3></div>
<br/>
<input className={styles.emailField} type="email" name="email" placeholder="Email address" required />
...
<input type="submit" className="button button--secondary button--lg" value="Subscribe" />
</div>
</form>
