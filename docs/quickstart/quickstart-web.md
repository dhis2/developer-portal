...
1. From the browser, navigate to your DHIS2 instance URL (if you're running DHIS2 locally via container the address is [http://localhost:8080](http://localhost:8080)). You will see the following page:
